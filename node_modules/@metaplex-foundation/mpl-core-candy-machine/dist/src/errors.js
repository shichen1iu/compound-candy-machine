...
exports.ExceededRegexLengthError = exports.MaximumOfFiveAdditionalProgramsError = exports.MintOwnerMustBeMintPayerError = exports.UnrecognizePathForRouteInstructionError = exports.GuardGroupLabelTooLongError = exports.GuardNotEnabledError = exports.CandyGuardRequiredOnCandyMachineError = exports.GuardRouteNotSupportedError = exports.GuardMintSettingsMissingError = exports.SelectedGuardGroupDoesNotExistError = exports.GuardGroupRequiredError = exports.UnregisteredCandyGuardError = exports.VariableSizeGuardError = exports.CandyMachineError = void 0;
...
class ExceededRegexLengthError extends CandyMachineError {
    constructor() {
        const message = `The maximum length of a regex that can be used is 100 characters. ` +
            'Please reduce the length of the regex to <= 100.';
        super(message);
        this.name = 'ExceededRegexLengthError';
    }
}
exports.ExceededRegexLengthError = ExceededRegexLengthError;
