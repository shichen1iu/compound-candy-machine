...
exports.getMplCoreCandyGuardErrorFromName = exports.getMplCoreCandyGuardErrorFromCode = exports.CgInvalidRegexError = exports.CgInvalidVanityAddressError = exports.CgExceededRegexLengthError = exports.CgInvalidAccountVersionError = exports.CgInstructionBuilderFailedError = void 0;
...
class CgExceededRegexLengthError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Exceeded the maximum length of a regex that can be used', program, cause);
        this.name = 'ExceededRegexLength';
        this.code = 0x17a4; // 6052
    }
}
exports.CgExceededRegexLengthError = CgExceededRegexLengthError;
...
class CgInvalidVanityAddressError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Invalid vanity address', program, cause);
        this.name = 'InvalidVanityAddress';
        this.code = 0x17a5; // 6053
    }
}
exports.CgInvalidVanityAddressError = CgInvalidVanityAddressError;
...
class CgInvalidRegexError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Invalid regex', program, cause);
        this.name = 'InvalidRegex';
        this.code = 0x17a6; // 6054
    }
}
exports.CgInvalidRegexError = CgInvalidRegexError;
 ...
 * @category Errors
 */
function getMplCoreCandyGuardErrorFromCode(code, program, cause) {
    const constructor = codeToErrorMap.get(code);
    return constructor ? new constructor(program, cause) : null;
}
exports.getMplCoreCandyGuardErrorFromCode = getMplCoreCandyGuardErrorFromCode;
/**
 * Attempts to resolve a custom program error from the provided error name, i.e. 'Unauthorized'.
 * @category Errors
 */
function getMplCoreCandyGuardErrorFromName(name, program, cause) {
    const constructor = nameToErrorMap.get(name);
    return constructor ? new constructor(program, cause) : null;
}
exports.getMplCoreCandyGuardErrorFromName = getMplCoreCandyGuardErrorFromName;
