...
class CmIncorrectPluginAuthorityError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Invalid plugin authority', program, cause);
        this.name = 'IncorrectPluginAuthority';
        this.code = 0x178e; // 6030
    }
}
exports.CmIncorrectPluginAuthorityError = CmIncorrectPluginAuthorityError;
 ...
 * @category Errors
 */
function getMplCoreCandyMachineCoreErrorFromCode(code, program, cause) {
    const constructor = codeToErrorMap.get(code);
    return constructor ? new constructor(program, cause) : null;
}
exports.getMplCoreCandyMachineCoreErrorFromCode = getMplCoreCandyMachineCoreErrorFromCode;
/**
 * Attempts to resolve a custom program error from the provided error name, i.e. 'Unauthorized'.
 * @category Errors
 */
function getMplCoreCandyMachineCoreErrorFromName(name, program, cause) {
    const constructor = nameToErrorMap.get(name);
    return constructor ? new constructor(program, cause) : null;
}
exports.getMplCoreCandyMachineCoreErrorFromName = getMplCoreCandyMachineCoreErrorFromName;
//# sourceMappingURL=mplCoreCandyMachineCore.js.map