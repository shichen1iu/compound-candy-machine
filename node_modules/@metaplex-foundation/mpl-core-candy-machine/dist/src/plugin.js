...
const mplCandyMachine = () => ({
    install(umi) {
        ...
        // Programs.
        umi.programs.add((0, generated_1.createMplCoreCandyMachineCoreProgram)(), false);
        umi.programs.add({
            ...(0, generated_1.createMplCoreCandyGuardProgram)(),
        ...
        // Default Guards.
        umi.coreGuards = new guards_1.DefaultGuardRepository();
        umi.coreGuards.add(defaultGuards_1.botTaxGuardManifest, defaultGuards_1.solPaymentGuardManifest, defaultGuards_1.tokenPaymentGuardManifest, defaultGuards_1.startDateGuardManifest, defaultGuards_1.thirdPartySignerGuardManifest, defaultGuards_1.tokenGateGuardManifest, defaultGuards_1.gatekeeperGuardManifest, defaultGuards_1.endDateGuardManifest, defaultGuards_1.allowListGuardManifest, defaultGuards_1.mintLimitGuardManifest, defaultGuards_1.nftPaymentGuardManifest, defaultGuards_1.redeemedAmountGuardManifest, defaultGuards_1.addressGateGuardManifest, defaultGuards_1.nftGateGuardManifest, defaultGuards_1.nftBurnGuardManifest, defaultGuards_1.tokenBurnGuardManifest, defaultGuards_1.freezeSolPaymentGuardManifest, defaultGuards_1.freezeTokenPaymentGuardManifest, defaultGuards_1.programGateGuardManifest, defaultGuards_1.allocationGuardManifest, defaultGuards_1.token2022PaymentGuardManifest, defaultGuards_1.solFixedFeeGuardManifest, defaultGuards_1.nftMintLimitGuardManifest, defaultGuards_1.editionGuardManifest, defaultGuards_1.assetPaymentGuardManifest, defaultGuards_1.assetBurnGuardManifest, defaultGuards_1.assetMintLimitGuardManifest, defaultGuards_1.assetBurnMultiGuardManifest, defaultGuards_1.assetPaymentMultiGuardManifest, defaultGuards_1.assetGateGuardManifest, defaultGuards_1.vanityMintGuardManifest);
    },
});
